...
{    
    QFile file("/home/user/setserial.txt");
    QByteArray data;
    ...
    system("echo 123456789 | sudo -S setserial -a /dev/ttyS0 >/home/user/setserial.txt");
    ...
    system("echo 123456789 | sudo -S setserial /dev/ttyS0 baud_base 57600 >/home/user/setserial.txt");
    ...
    text5->setProperty("text", strResult+"\n\n                                                Изменение скорости через setserial\n"+
                       "\necho 123456789 | sudo -S setserial -a /dev/ttyS0\n"+data1+
                       "\necho 123456789 | sudo -S setserial /dev/ttyS0 baud_base 115200\n"+
                       "\necho 123456789 | sudo -S setserial -a /dev/ttyS0\n"+data2);
}
